...
from game import GameStrategy, GameMoveNode, NotTerminalNodeError
...
class MonteCarloTreeSearch():
    ...
    def __explore_moves(self, root: GameMoveNode):
        selected_node = self.__game_strategy.expand_moves(root)
        depth = 0
        
        while not self.__game_strategy.no_moves_left(selected_node):
        ...
        simulation_result = self.__game_strategy.random_game(selected_node)
